	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			if(ts.p.pgbuttons===true) {
				...
				pgl += "<td id='"+po[0]+"' class='ui-pg-button ui-corner-all'><span class='ui-icon glyphicon glyphicon-step-backward'></span></td>";
				pgl += "<td id='"+po[1]+"' class='ui-pg-button ui-corner-all'><span class='ui-icon glyphicon glyphicon-backward'></span></td>";
				pgl += pginp !== "" ? sep+pginp+sep:"";
				pgl += "<td id='"+po[2]+"' class='ui-pg-button ui-corner-all'><span class='ui-icon glyphicon glyphicon-forward'></span></td>";
				pgl += "<td id='"+po[3]+"' class='ui-pg-button ui-corner-all'><span class='ui-icon glyphicon glyphicon-step-forward'></span></td>";
		...
		.append("<span class='ui-icon ui-jqgrid-headlink glyphicon glyphicon-circle-arrow-up'></span>").css((dir==="rtl"?"left":"right"),"0px") : "";
				...
				$(".ui-jqgrid-titlebar-close",grid.cDiv).click( function(e){
					...
					if(ts.p.gridstate === 'visible') {
						$(elems,"#gbox_"+$.jgrid.jqID(ts.p.id)).slideUp("fast", function() {
							counter--;
							if (counter === 0) {
								$("span",self).removeClass("ui-jqgrid-headlink glyphicon glyphicon-circle-arrow-up").addClass("ui-jqgrid-headlink glyphicon glyphicon-circle-arrow-down");
						...
						$(elems,"#gbox_"+$.jgrid.jqID(ts.p.id)).slideDown("fast", function() {
							counter--;
							if (counter === 0) {
								$("span",self).removeClass("ui-jqgrid-headlink glyphicon glyphicon-circle-arrow-down").addClass("ui-jqgrid-headlink glyphicon glyphicon-circle-arrow-up");
	...
	setGridState : function(state) {
		return this.each(function(){
			...
			if(state === 'hidden'){
				...
				$(".ui-jqgrid-titlebar-close span",$t.grid.cDiv).removeClass("ui-jqgrid-headlink glyphicon glyphicon-circle-arrow-up").addClass("ui-jqgrid-headlink glyphicon glyphicon-circle-arrow-down");
				...
				$(".ui-jqgrid-titlebar-close span",$t.grid.cDiv).removeClass("ui-jqgrid-headlink glyphicon glyphicon-circle-arrow-down").addClass("ui-jqgrid-headlink glyphicon glyphicon-circle-arrow-up");
...
"use strict";	
	...
	$.fn.fmatter.actions = function(cellval,opts) {
		...
		if(op.editformbutton){
			...
			str += "<div title='"+$.jgrid.nav.edittitle+"' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' "+ocl+"><span class='ui-icon glyphicon glyphicon-edit'></span></div>";
		...
		if(op.delbutton) {
			...
			str += "<div title='"+$.jgrid.nav.deltitle+"' style='float:left;margin-left:5px;' class='ui-pg-div ui-inline-del' "+ocl+"><span class='ui-icon glyphicon glyphicon-trash'></span></div>";
		}
	...
	searchGrid : function (p) {
		...
		return this.each(function() {
			...
			if ( $("#"+$.jgrid.jqID(IDs.themodal))[0] !== undefined ) {
				...
				bS  ="<a id='"+fid+"_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon glyphicon glyphicon-search'></span>"+p.Find+"</a>",
